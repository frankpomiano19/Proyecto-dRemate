...
class ProductoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('productos')->insert(['nombre_producto'=>'Mazo de platano','descripcion'=>'Maso hecho de oro 100% oro','precio_inicial'=>1990.0,'imagen'=>'http://imgfz.com/i/g7Alfst.jpeg','estado'=>'Comprado','inicio_subasta'=>'2020-11-25 20:47:00','final_subasta'=>'2020-11-30 20:47:00','user_id'=>1,'categoria_id'=>1]);
        DB::table('productos')->insert(['nombre_producto'=>'La paisna jacinta','descripcion'=>'Libro original de Servantes, lo vendo porque necesito espacio en mi casa','precio_inicial'=>100.2,'imagen'=>'http://imgfz.com/i/bEdwRlf.jpeg','estado'=>'Comprado','inicio_subasta'=>'2020-11-5 20:47:00','final_subasta'=>'2020-11-10 20:47:00','user_id'=>2,'categoria_id'=>2]);
        DB::table('productos')->insert(['nombre_producto'=>'Mandaria huayro','descripcion'=>'Maso hecho de oro 100% oro','precio_inicial'=>1990.0,'imagen'=>'http://imgfz.com/i/vrnLG64.jpeg','estado'=>'Comprado','user_id'=>1,'categoria_id'=>1]);
        DB::table('productos')->insert(['nombre_producto'=>'Libro de comunicacion','descripcion'=>'Libro original de Servantes, lo vendo porque necesito espacio en mi casa','precio_inicial'=>100.2,'imagen'=>'http://imgfz.com/i/Qvz10x7.png','estado'=>'Comprado','inicio_subasta'=>'2020-11-25 20:47:00','final_subasta'=>'2020-11-30 20:47:00','user_id'=>2,'categoria_id'=>2]);
