...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert(['usuario'=>'perrovaca','us_din'=>20,'us_descp'=>'Ninguna','email'=>'valor@asdaw.com','email_verified_at'=>now(),'password'=>Hash::make('perrovaca'),'remember_token' => Str::random(10)]);
        ...
        DB::table('users')->insert(['usuario'=>'cruzmanuelar','us_din'=>10000,'us_descp'=>'Ninguna','email'=>'cruzmanuelar@gmail.com','email_verified_at'=>now(),'password'=>Hash::make('132012Manu'),'remember_token' => Str::random(10)]);
    }   
}
