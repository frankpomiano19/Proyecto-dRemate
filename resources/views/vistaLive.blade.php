        ...
        <div class="row">
            <div class="col-3 uno">
                ...
                <form>
                    ...
                    <input class="btn btn-success btn-block my-2" type="submit" value="Filtrar">
                </form>
            </div>
            ...
            <div class="col-sm-12 col-lg-9 dos">
                ...
                <div>
                    <form action="" method="" >
                        <select class="form-control" onchange="this.form.action = this.value; this.disabled = true; this.form.submit()" >
