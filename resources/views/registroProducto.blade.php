...
<div class="container-md border rounded-lg cuerpo">
    ...
    <form id="demo-form" data-parsley-validate="" novalidate method="POST" enctype="multipart/form-data"
        ...
        <div class="col-sm-12 col-md-8 col-lg-6 col-xl-6 form-group">
            ...
            <select class="form-control" name="categoria" id="heard" required=""
                data-parsley-error-message="Seleccione una categoría">
        ...
        <div class="col-sm-12 col-md-8 col-lg-7 col-xl-6">
            ...
            <input type="text" class="form-control" name="nombre" id="titulo" placeholder="Nombre del producto" required
                data-parsley-error-message="Es necesario un título">
            <div class="invalid-feedback">
        ...
        <div class="col-sm-12 col-md-8 col-lg-7 col-xl-6 form-group">
            ...
            <textarea input type="text" class="form-control" placeholder="Añade una descripción" name="message"
                data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="200"
                data-parsley-minlength-message="Tu descripción debe tener por lo menos 20 caracteres"
                data-parsley-validation-threshold="10" rows="4"></textarea>
            <div class="invalid-feedback">
        ...
        <div class="col-sm-12 col-md-8 col-lg-7 col-xl-6">
            ...
            <div class="custom-file">
                <input type="file" class="custom-file-input" required
                    data-parsley-error-message="Sube por lo menos una imagen"><br>
        ...
        <div class="col-sm-12 col-md-8 col-lg-7 col-xl-6">
            ...
            <textarea input type="text" class="form-control" name='garantia' placeholder="Añade una descripción"
                id="validationCustom05" rows="2"></textarea>
            <br>
        </div>
